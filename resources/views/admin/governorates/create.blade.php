    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.governorates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('governorate_name') ? 'is-invalid' : '' }}" type="text" name="governorate_name" id="governorate_name" value="{{ old('governorate_name', '') }}" required>
