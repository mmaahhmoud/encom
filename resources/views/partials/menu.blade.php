<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="{{ route("admin.home") }}" class="brand-link">
        <span class="brand-text font-weight-light">22{{ trans('panel.site_title') }}</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('main_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/visitors*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            @can('visitor_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.visitors.index") }}" class="nav-link {{ request()->is("admin/visitors") || request()->is("admin/visitors/*") ? "active" : "" }}">
                ...
                @endcan
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/governorates*") ? "menu-open" : "" }} {{ request()->is("admin/departements*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
